...
public class RenderUtils {
    ...
    public static void outlineBlock(MatrixStack matrices, VertexConsumer vertexConsumer, double camX, double camY, double camZ, BlockPos pos, float r, float g, float b) {
